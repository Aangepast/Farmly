        ...
        if (e.getMaterial() == Material.CHICKEN_SPAWN_EGG && e.getAction() == Action.RIGHT_CLICK_BLOCK) {
            ...
            if (e.getClickedBlock().getType() == Material.HAY_BLOCK) {
                ...
                if (e.getClickedBlock().getRelative(BlockFace.DOWN).getType() == Material.YELLOW_CONCRETE) {
                    ...
                    FarmData farm = PlayerUtility.getFarmData(e.getPlayer());

                    if(FarmUtilities.isInArea(e.getClickedBlock().getLocation(), farm.getMinPos(), farm.getMaxPos())){
                        ...
                        e.getPlayer().sendMessage(ChatColor.RED + "You cannot interact with this farm.");
